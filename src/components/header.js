    ...
    >
      <Link to="/" aria-label="Website logo, go back to homepage.">
        ...
        <svg
          ...
          className="h-12 sm:h-10 w-12 sm:w-10 fill-current hover:text-accent transition duration-150"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 580.000000 386.000000"
        >
          <g transform="translate(0.000000,386.000000) scale(0.100000,-0.100000)"
fill="#707a82" stroke="none">
         <path d="M3476 2755 c-111 -21 -116 -26 -64 -60 61 -40 201 -179 245 -242 44
-64 46 -62 69 68 15 87 15 221 1 235 -13 14 -177 13 -251 -1z"/>
<path d="M3190 2657 c-95 -48 -225 -135 -306 -204 -80 -69 -262 -254 -353
-358 l-60 -70 261 -262 262 -262 47 40 c186 155 384 363 478 499 58 85 141
237 141 259 0 23 -85 137 -159 214 -71 74 -208 177 -234 177 -7 0 -41 -15 -77
-33z m176 -261 c29 -29 34 -41 34 -79 0 -54 -33 -100 -84 -117 -27 -9 -42 -8
-74 5 -124 50 -89 225 45 225 38 0 50 -5 79 -34z"/>
<path d="M2190 2223 c-109 -109 -121 -125 -95 -120 17 3 81 13 143 23 l113 17
32 -32 33 -31 97 109 c111 126 118 109 -58 136 -55 8 -109 17 -120 20 -16 3
-50 -25 -145 -122z"/>
<path d="M2462 1853 c-12 -21 -31 -52 -41 -68 l-20 -31 162 -162 162 -161 55
35 c30 19 62 39 70 44 12 7 -25 49 -170 195 -102 102 -187 185 -191 185 -3 0
-15 -17 -27 -37z"/>
<path d="M3234 1609 c-16 -17 -64 -60 -107 -96 l-78 -66 32 -33 32 -33 -17
-113 c-10 -62 -20 -126 -23 -143 -5 -26 10 -14 119 93 l125 123 -22 145 c-12
79 -24 146 -27 149 -2 3 -18 -9 -34 -26z"/>
<path d="M2355 1541 c-84 -53 -143 -150 -152 -252 l-6 -58 39 5 c145 21 256
96 283 190 27 97 -77 169 -164 115z"/></g></svg>
        {/* <svg
          aria-hidden="true"
          className="h-12 sm:h-10 w-12 sm:w-10 fill-current hover:text-accent transition duration-150"
          viewBox="0 0 128 128"
